...
const dict: Record<Lang, Record<string, any>> = {
  en: {
    ...
    prank: {
      ...
      caught2: "Well, since you've clicked on it…",
      proceed: "Proceed",
      question: "What do you expect to find here?",
      optA: "A) A treasure chest", optB: "B) The unexpected", optC: "C) A hidden task",
  ...
  zh: {
    ...
    prank: {
      ...
      proceed: "继续",
      question: "你期待在这里找到什么？",
      optA: "A) 一个宝箱", optB: "B) 意想不到的东西", optC: "C) 一个隐藏任务",
      wrong: "你猜错了。",
      goHome: "返回首页",
    },
  ...
  ko: {
    ...
    prank: {
      ...
      caught2: "음, 이미 눌렀으니……",
      proceed: "계속하기",
      question: "여기서 무엇을 찾을 거라고 생각했나요?",
      optA: "A) 보물 상자", optB: "B) 예상치 못한 것", optC: "C) 숨겨진 임무",
      wrong: "틀렸습니다.",
      goHome: "홈으로 가기",
    },
